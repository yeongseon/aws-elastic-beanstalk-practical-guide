...
This page tracks which tutorials have been validated against real AWS deployments. Each tutorial can be tested via **aws-cli** (manual CLI commands) or **CloudFormation** (infrastructure as code). Tutorials not tested within 90 days are marked as stale.
...
|---|---|---|---|---|
| [01 Local Run](../language-guides/dotnet/01-local-run.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |
...
| [07 Custom Domain Ssl](../language-guides/dotnet/07-custom-domain-ssl.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |

### Java

| Tutorial | aws-cli | CloudFormation | Last Tested | Status |
|---|---|---|---|---|
| [01 Local Run](../language-guides/java/01-local-run.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |
...
| [07 Custom Domain Ssl](../language-guides/java/07-custom-domain-ssl.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |

### Node.js

| Tutorial | aws-cli | CloudFormation | Last Tested | Status |
|---|---|---|---|---|
| [01 Local Run](../language-guides/nodejs/01-local-run.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |
...
| [07 Custom Domain Ssl](../language-guides/nodejs/07-custom-domain-ssl.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |

### Python

| Tutorial | aws-cli | CloudFormation | Last Tested | Status |
|---|---|---|---|---|
| [01 Local Run](../language-guides/python/01-local-run.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |
...
| [07 Custom Domain Ssl](../language-guides/python/07-custom-domain-ssl.md) | ➖ No Data | ➖ No Data | — | ➖ Not Tested |
...
!!! info "Validation fields"
    ...
    - `cli_version`: AWS CLI version used
